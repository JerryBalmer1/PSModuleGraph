---
subject: "psmodule:PSModuleGraph/function/Invoke-HtmlConfigurationConstraint"
facet: "surface"
...
`Export-ModuleMember`, which this module never evaluates because it never runs the
code it analyses.
